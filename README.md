...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/blue-truth-2f67
```

A live public deployment of this template is available at [https://blue-truth-2f67.templates.workers.dev](https://blue-truth-2f67.templates.workers.dev)
